...
<div id="cont_principal">
    <div class="container-fluid" id="container_a">
        ...
        <div class="d-flex justify-content-end mb-3">
            <a href="{{ route('customers_otro.create') }}" class="btn btn-success btn-lg shadow">
                ➕ Nueva Usuario
            </a>
        </div>
                    ...
                    @forelse($customers as $customer)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('customers_otro.edit', $customer) }}" class="btn btn-sm btn-warning shadow-sm" data-bs-toggle="tooltip" title="Editar Cliente">
                                    ✏️ Editar
                                </a>

                                <form action="{{ route('customers_otro.destroy', $customer) }}" method="POST" class="d-inline">
                       →             @csrf @method('DELETE')
