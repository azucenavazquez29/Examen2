...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-start mb-4">
        <div>
            <h1 style="color:white !important;" class="h3 fw-bold text-dark">Editar Cliente</h1>
            <p style="color:white !important;" class="text-muted mt-2">Actualiza la información del cliente</p>
        </div>
    ...
    <form action="{{ route('customers.update', $cliente->customer_id) }}" method="POST" class="card shadow-sm">
        @csrf
        @method('PUT')
                    ...
                    >
                        ...
                        @foreach($addresses as $address)
                            <option value="{{ $address->address_id }}" 
                                {{ old('address_id', $cliente->address_id) == $address->address_id ? 'selected' : '' }}>
                                {{ $address->address }}
